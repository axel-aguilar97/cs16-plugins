...
new g_MuzzleFlash_SprId, g_PlasmaExp_SprId, g_weapon_event, g_MaxPlayers
...
public plugin_natives()
	register_native("zp_weapon_plasmagun", "native_get_plasmagun", 1);

public native_get_plasmagun(const id)
{
...
public zp_user_infected_post(const id, const attacker, const silent_mode, const bomb, const first_zombie, const nemesis) Remove_Plasma(id)
public zp_user_humanized_post(const id, const silent_mode, const survivor) Remove_Plasma(id)
public fw_PlayerSpawn_Post(id) Remove_Plasma(id)
